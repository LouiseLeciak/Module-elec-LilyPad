...
/// @brief Sets the drawing area of a specific GC09101 LCD to full screen and fills the screen with the color
...
/// @brief Write to a specific GC09A01 LCD a number of pixels of the color to the SPI BUS
/// @param color Color to be drawn to screen format RGB-565
...
/// @brief Sets the drawing area of BOTH GC09101 LCDs to full screen and fills the screen with the color
/// @param color Color to be drawn to screen format RGB-565
/// @attention calls helper functions GC9A01_setAddrWindow_eyes(), GC9A01_pushColor_eyes()
void GC9A01_fillScreen_eyes(uint16_t color);

/// @brief Write to a BOTH GC09A01 LCDs a number of pixels of the color to the SPI BUS
/// @param color Color to be drawn to screen format RGB-565
/// @param pixels Number of pixels to be written to ex: 57600 is Full Screen
...
/// @param hSizeBytes width of the image in bytes (so width in pixels = hSizeBytes * 8)
